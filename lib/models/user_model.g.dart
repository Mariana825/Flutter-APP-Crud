...
void _userSerialize(
  ...
  writer.writeDateTime(offsets[3], object.registerDate);
...
User _userDeserialize(
  ...
  object.id = id;
  object.registerDate = reader.readDateTime(offsets[3]);
  return object;
}
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, DateTime, QQueryOperations> registerDateProperty() {
    return QueryBuilder.apply(this, (query) {
